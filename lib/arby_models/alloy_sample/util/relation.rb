require 'arby_models/alloy_sample/util/__init'

module ArbyModels::AlloySample::Util

  # ==============================================================
  # Utilities for some common operations and constraints on binary
  # relations. The keyword 'univ' represents the top-level type, which
  # all other types implicitly extend.  Therefore, all the functions
  # and predicates in this model may be applied to binary relations of
  # any type.
  #
  # @author: Greg Dennis
  # @translated_by: Greg Dennis
  # ==============================================================
  alloy :Relation do
